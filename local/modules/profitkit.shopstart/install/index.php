...
class profitkit_shopstart extends CModule
{
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('PROFITKIT_SHOP_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('PROFITKIT_SHOP_MODULE_DESCRIPTION');
        $this->MODULE_GROUP_RIGHTS = 'N';
        $this->PARTNER_NAME = Loc::getMessage('PROFITKIT_SHOP_MODULE_PARTNER_NAME');
