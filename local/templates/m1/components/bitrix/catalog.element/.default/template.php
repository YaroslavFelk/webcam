...
<div>Нет в наличии</div>
    ...
    <div id="<?=$itemIds['TABS_PANEL_ID']?>">
            ...
            <div>
                <div class="product-item-detail-tabs-container">
                    <ul class="product-item-detail-tabs-list">
                        ...
                        if (!empty($arResult['PROPERTIES'][$file_property]['VALUE']))
                        {
                            ?>
                            <li class="product-item-detail-tab" data-entity="tab" data-value="files">
                                <a href="javascript:void(0);" class="product-item-detail-tab-link">
                                    <span><?= Loc::getMessage("CATALOG_TAB_FILES") ?></span>
                                </a>
                            </li>
                            <?
                        }
        ...
        <div class="tab_content_wrap">
            ...
            if (!empty($arResult['PROPERTIES'][$file_property]['VALUE'])) { ?>
                <div class="product-item-detail-tab-content" data-entity="tab-container" data-value="files">
                    <? foreach ($arResult['PROPERTIES'][$file_property]['VALUE'] as $k => $v) {
                        $src = CFile::GetPath($v);
                        ?>
                        <a target="_blank" href="<?=$src;?>"><?=$arResult['PROPERTIES'][$file_property]['DESCRIPTION'][$k];?></a><br>
                    <? } ?>
                </div>
                <?
            }
