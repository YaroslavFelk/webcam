...
{
?>
<div class="<? echo $arCurView['LIST']; ?> row">
<?
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
                ...
                if ($intCurrentDepth < $arSection['RELATIVE_DEPTH_LEVEL'])
                {
                    if (0 < $intCurrentDepth)
                        echo "\n",str_repeat("\t", $arSection['RELATIVE_DEPTH_LEVEL']),'<div class="sub_section">';
                }
				...
				?><div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"<? if ($arSection['RELATIVE_DEPTH_LEVEL'] == 1) { ?> class="col-6"<? } ?>>
				<a
					href="<? echo $arSection['SECTION_PAGE_URL']; ?>"
                    <? if ($arSection['RELATIVE_DEPTH_LEVEL'] == 1) { ?>class="bx_catalog_line_img"
                ...
                if ($arSection['RELATIVE_DEPTH_LEVEL'] == 1) {
                    if ($arSection['UF_TOP_SEO']) {
                        ?><p class="bx_catalog_line_description"><? echo $arSection['UF_TOP_SEO']; ?></p><?
                    } elseif ('' != $arSection['DESCRIPTION'] and $arParams['SHOW_DESCRIPTION'] != 'N') {
