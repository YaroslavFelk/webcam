...
?>
<div class="catalog_items row<? if ($arParams['ITEM_TYPE'] == 'table') { ?> table_view<? } elseif ($arParams['SHOW_FROM_SECTION'] == 'Y') { ?> max_col-4<? } ?>" data-entity="<?=$containerName?>">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEMS'] as $item)
		{
            ...
            if (!$arParams['ITEM_TYPE'])
                $arParams['ITEM_TYPE'] = 'card';
