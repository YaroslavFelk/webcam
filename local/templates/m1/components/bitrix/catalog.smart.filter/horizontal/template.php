			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box">
											...
											<div class="checkbox">
                                                <input
                                                    ...
                                                    <? echo $ar["CHECKED"]? 'checked="checked"': '' ?>
                                                        onclick="smartFilter.click(this)"
                                                />
												<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="fld_checkbox bx-filter-param-label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
													<span class="bx-filter-input-checkbox">
					...
					<div class="bx-filter-block0">
						<div class="bx-filter-parameters-box-container">
							...
							<div class="bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
                                ...
                                <a class="btn btn-themes" href="<?echo $arResult["FILTER_URL"]?>" target=""><?echo GetMessage("CT_BCSF_FILTER_SHOW")?> <span>(<span id="modef_num"><?=intval($arResult["ELEMENT_COUNT"]);?></span>)</span></a>
                                <input
                                        class="btn btn-link"
                                        type="submit"
                                        id="del_filter"
                ...
                <div class="bx-filter-button-box"><div class="bx-filter-parameters-box-container">
                    <input
                            class="btn btn-link"
                            type="submit"
                            id="del_filter"
