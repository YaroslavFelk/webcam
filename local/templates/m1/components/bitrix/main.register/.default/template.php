...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	<?else:?>
        <div class="fld_row<? if ($FIELD == 'PASSWORD') { ?> fld_password<? } ?>"><label><?=GetMessage("REGISTER_FIELD_".$FIELD)?>:<?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span class="starrequired">*</span><?endif?></label>
			<?
	switch ($FIELD)
	{
		case "PASSWORD":
			?><input size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="bx-auth-input" /><i></i>
...
?>
    <div class="fld_row">
	<input type="submit" name="register_submit_button" class="btn" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
    </div>
</form>
